...
document.addEventListener("DOMContentLoaded", function() {
    ...
    Promise.all([
        d3.json("eau_v2.geojson"),
        d3.json("parcs.geojson"),
        d3.json("routes_v4.geojson"),//"http://localhost:8000/routes_v4.geojson"
        d3.json("old_trees2.geojson"),
        d3.json("ref_voies.geojson"),
        d3.json("ref_voies2.geojson"),
...
function updateSelectedTree3(selectedTreeIndex) {
    ...
    // data
    d3.json("old_trees2.geojson").then(data => {
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledGFP > 0 ? xScale(-40): -xScale(-70)); //1er change à gauche 
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledGFP > 0 ? xScale(-32): -xScale(-78));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledLAD > 0 ? xScale(-38): -xScale(-72));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledLAD  > 0 ? xScale(-32): -xScale(-78));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledINT > 0 ? xScale(-35): -xScale(-75));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledINT  > 0 ? xScale(-32): -xScale(-78));
            }) 
