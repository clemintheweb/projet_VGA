...
function updateSelectedTree3(selectedTreeIndex) {
    ...
    d3.json("old_trees2.geojson").then(data => {
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledLAD > 0 ? xScale(-30): -xScale(-70));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledLAD  > 0 ? xScale(-20): -xScale(-80));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledINT > 0 ? xScale(-30): -xScale(-70));
            }) 
        ...
        Indicesvg.append('text')
            .attr('x', function() {
        return xScale(0) - (ScaledINT  > 0 ? xScale(-25): -xScale(-75));
            }) 
